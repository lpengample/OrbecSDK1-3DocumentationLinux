...
pipe.stop();
```
The final color map is shown below.<br />![3](./Orbbec%20SDK%20Sample%20Description%20(CC++)img/3.png)<br />Resources will be automatically released after the program exits normally.
## InfraredViewer
